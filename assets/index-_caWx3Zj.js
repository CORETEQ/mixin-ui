import{ɵ as c,D as o,M as m,c as d,g as s,e as h,i as u,j as b}from"./index-CmsTAVfl.js";const p=`## 0.0.1-alpha.4 (2025-10-15)
...
This was a version bump only, there were no code changes.`,i=class i{constructor(){this.changelog=p}};i.ɵfac=function(t){return new(t||i)},i.ɵcmp=c({type:i,selectors:[["app-changelog"]],decls:2,vars:1,consts:[[3,"data"]],template:function(t,e){t&1&&(d(0,"docs-page"),s(1,"markdown",0),h()),t&2&&(u(),b("data",e.changelog))},dependencies:[o,m],encapsulation:2,changeDetection:0});let n=i;export{n as default};

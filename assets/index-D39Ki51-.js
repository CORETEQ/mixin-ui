import{ɵ as a,D as m,M as c,c as s,f as p,e as u,g as r,h}from"./index-D3yi40MR.js";const d=`## 0.0.1-alpha.37 (2025-07-30)

This was a version bump only, there were no code changes.

## 0.0.1-alpha.36 (2025-07-30)

This was a version bump only, there were no code changes.

## 0.0.1-alpha.35 (2025-07-30)

This was a version bump only, there were no code changes.

## 0.0.1-alpha.34 (2025-07-30)

This was a version bump only, there were no code changes.

## 0.0.1-alpha.33 (2025-07-30)

### 🚀 Features

- **cli:** test schematics ([c12f75b](https://github.com/CORETEQ/mixin-ui/commit/c12f75b))
...
- **cli:** test schematics ([74c756e](https://github.com/CORETEQ/mixin-ui/commit/74c756e))
...
- **cdk:** test schematics ([6db8e35](https://github.com/CORETEQ/mixin-ui/commit/6db8e35))

## 0.0.1-alpha.28 (2025-07-29)

### 🚀 Features

- **cdk:** test schematics ([34eeca0](https://github.com/CORETEQ/mixin-ui/commit/34eeca0))

## 0.0.1-alpha.27 (2025-07-29)

### 🚀 Features

- **cdk:** test schematics ([ab4e8e3](https://github.com/CORETEQ/mixin-ui/commit/ab4e8e3))

## 0.0.1-alpha.26 (2025-07-29)

### 🚀 Features

- **cdk:** test schematics ([f672e6e](https://github.com/CORETEQ/mixin-ui/commit/f672e6e))
...
`,t=class t{constructor(){this.data=d}};t.ɵfac=function(i){return new(i||t)},t.ɵcmp=a({type:t,selectors:[["app-changelog"]],decls:2,vars:1,consts:[[3,"data"]],template:function(i,o){i&1&&(s(0,"docs-page"),p(1,"markdown",0),u()),i&2&&(r(),h("data",o.data))},dependencies:[m,c],encapsulation:2,changeDetection:0});let e=t;export{e as default};
